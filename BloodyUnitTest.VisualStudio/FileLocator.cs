...
{
    public class FileWithScore
    {
        public int Score { get; }
        public string FilePath { get; }

        public FileWithScore(int score, string filePath)
        {
            Score = score;
            FilePath = filePath;
        }
    ...
    public class FileLocator
    {
        ...
        public static IEnumerable<FileWithScore> GetBinariesNearFolder(string folderPath,
                                                                       string[] nameSpaceParts)
        {
            ...
            if (binaries?.Any() == true)
            {
                foreach (var filePath in binaries)
                {
                    ...
                    if (score == 0) continue;
                    yield return new FileWithScore(score, filePath);
                }
            }
        }
